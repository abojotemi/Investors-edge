...
export default function AdminDiscussionDetailPage() {
  ...
  const handleTogglePin = async () => {
    ...
    try {
      await updateDiscussion(discussionId, { pinned: !discussion.pinned });
      toast.success(
        discussion.pinned ? "Discussion unpinned" : "Discussion pinned"
      );
    } catch (error) {
  ...
  const handleChangeStatus = async (status: DiscussionStatus) => {
    try {
      await updateDiscussion(discussionId, { status });
    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="flex flex-wrap items-center gap-3">
            ...
            <Button
              ...
              className={discussion.pinned ? "text-primary-orange" : ""}
            >
            ...
            <Select
              ...
              onValueChange={(value) =>
                handleChangeStatus(value as DiscussionStatus)
              }
            >
        ...
        >
          ...
          <div className="flex items-center gap-4 mb-6 pb-6 border-b border-gray-100">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">{discussion.author?.email}</p>
        ...
        <motion.div
          ...
          className="bg-white rounded-2xl p-6 shadow-lg border border-primary-green/20"
        >
          <div className="flex items-center gap-2 mb-4">
