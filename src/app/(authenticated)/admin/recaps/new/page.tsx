...
import { addWeeklyRecap } from "@/lib/firebase/firestore";
    ...
    try {
      ...
      toast.success(
        status === "published"
          ...
          : "Weekly recap saved as draft"
      );
      router.push("/admin/recaps");
    } catch (error) {
      console.error("Error saving recap:", error);
      toast.error("Failed to save weekly recap");
    } finally {
      setSaving(false);
    }
  };
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-gray-600 mt-1">
            Create a new weekly market highlights recap
          </p>
        </motion.div>
